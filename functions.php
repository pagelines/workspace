...
class workspaceTheme {
	...
	function welcome(){
      ...
      <div class="row">
        ...
        <div class="span6 zmb" style="text-align:center;">
          <a href="http://www.pagelines.com/forum/forum/68-store-products/" target="_blank" class="btn btn-info btn-mini"><i class="icon icon-ambulance"></i>  <?php _e('Support','workspace');?></a>
        </div>
      </div>
      ...
      <div style="margin-top:20px;color:#444;">
        ...
        <ul class="unstyled" style="font-size:12px;line-height:14px;">
          ...
          <li style="margin-bottom:7px;"><strong><?php _e('7.','workspace');?> </strong><?php _e('To edit the main color of the theme, simply change the Link Color in Global Options and your entire theme will change to match.','workspace');?></li>
				</ul>
			</div>
		<?php
		return ob_get_clean();
